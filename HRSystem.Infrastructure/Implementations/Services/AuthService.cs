...
namespace HRSystem.Infrastructure.Implementations
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(HRSystemContext context, ITokenService tokenService, IConfiguration configuration, IMemberRepository memberRepo)
        {
            _context = context;
        ...
        public async Task<UserReadDto> RegisterAsync(UserRegisterDto request)
        {
            ...
            try
            {
                ...
                var newMember = new MEMBER
                {
                    ...
                    email = newUser.email,
                    first_name = request.fullname.Split(' ').FirstOrDefault() ?? "N/A",
                    last_name = request.fullname.Split(' ').LastOrDefault() ?? "N/A",
                    phone = newUser.phone,
